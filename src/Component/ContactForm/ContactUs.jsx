...
const [ sendText, setsendText]= useState('Send')
  ...
  return (
    ...
    <form ref={form} onSubmit={sendEmail} className="flex flex-col  mx-auto  md:w-3/6"  >
      ...
      <input className=" bshadow inputfild " placeholder="Type your name..." type="text" name="user_name" required />
      
      <label className="label">Email:</label>
      <input className=" bshadow inputfild" type="email" placeholder="Type your email..." name="user_email" required />
      
      <label className="label">Message:</label>
      <textarea className=" bshadow inputfild resize-none" placeholder="Type your message..." name="message" required   />
